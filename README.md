...
Take the opportunity to play with Monocular Depth Estimation using MiDaS. For a sandbox to play in — register for a free account on the **[Intel Tiber Developer Cloud](cloud.intel.com)**
